...
final class TLV
{
    ...
    public const TAG_DEST_NETWORK_TYPE           = 0x0006;
    public const TAG_DEST_BEARER_TYPE            = 0x0007;
    public const TAG_DEST_TELEMATICS_ID          = 0x0008;
    public const TAG_SOURCE_ADDR_SUBUNIT         = 0x000D;
    public const TAG_SOURCE_NETWORK_TYPE         = 0x000E;
    public const TAG_SOURCE_BEARER_TYPE          = 0x000F;
    public const TAG_SOURCE_TELEMATICS_ID        = 0x0010;
    ...
    public const TAG_SOURCE_SUBADDRESS           = 0x0202;
    public const TAG_DEST_SUBADDRESS             = 0x0203;
    ...
    public const TAG_SAR_SEGMENT_SEQNUM          = 0x020F;
    ...
    public const TAG_MESSAGE_STATE               = 0x0427;
    public const TAG_USSD_SERVICE_OP             = 0x0501;

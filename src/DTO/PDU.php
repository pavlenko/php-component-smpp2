...
final class PDU
{
    ...
    public const ALLOWED_TLV_BY_ID = [
        ...
        self::ID_SUBMIT_SM => [
            ...
            TLV::TAG_SOURCE_PORT,
            TLV::TAG_SRC_ADDR_SUBUNIT,
            TLV::TAG_DESTINATION_PORT,
            TLV::TAG_DST_ADDRESS_SUBUNIT,
            TLV::TAG_SAR_MSG_REF_NUM,
            TLV::TAG_SAR_TOTAL_SEGMENTS,
            TLV::TAG_SAR_SEGMENT_SEQUENCE_NUM,
            ...
            TLV::TAG_SRC_SUB_ADDRESS,
            TLV::TAG_DST_SUB_ADDRESS,
            ...
            TLV::TAG_USSD_SERVICE_OPERATION,
        ],
        self::ID_DELIVER_SM => [
            TLV::TAG_USER_MESSAGE_REFERENCE,
            TLV::TAG_SOURCE_PORT,
            ...
            TLV::TAG_MESSAGE_STATUS,
            TLV::TAG_RECEIPTED_MESSAGE_ID,
        ],
        self::ID_DATA_SM => [
            TLV::TAG_SOURCE_PORT,
            TLV::TAG_SRC_ADDR_SUBUNIT,
            TLV::TAG_SRC_NETWORK_TYPE,
            TLV::TAG_SRC_BEARER_TYPE,
            TLV::TAG_SRC_TELEMATICS_ID,
            TLV::TAG_DESTINATION_PORT,
            TLV::TAG_DST_ADDRESS_SUBUNIT,
            TLV::TAG_DST_NETWORK_TYPE,
            TLV::TAG_DST_BEARER_TYPE,
            TLV::TAG_DST_TELEMATICS_ID,
            TLV::TAG_SAR_MSG_REF_NUM,
            TLV::TAG_SAR_TOTAL_SEGMENTS,
            TLV::TAG_SAR_SEGMENT_SEQUENCE_NUM,
            TLV::TAG_MORE_MESSAGES_TO_SEND,
